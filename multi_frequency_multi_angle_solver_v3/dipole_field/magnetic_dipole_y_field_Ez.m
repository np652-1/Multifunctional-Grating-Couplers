function [Ez] = magnetic_dipole_y_field_Ez(k, recPts, srcPts, srcdA, M)
% Calculate the electric field Ez from magnetic dipole My
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Inputs:
% M: dipole amplitude My, size (N1,1) or (ny, nx) N1=ny*nx, no k^2 prefactor
...
G = 1/4*k^2*(x-x0.')./r.*besselh(1,k*r)*srcdA;% Green's function matrix

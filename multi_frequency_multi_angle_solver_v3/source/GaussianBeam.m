function [Einc] = GaussianBeam(Pts, k, theta, w0, z0, x0, y0)
% This function produces a GaussianBeam as the incident electric field
% k: wave vector
% w0: waist radius
...
Einc = w0./w.*exp(-r.^2./w.^2).*phase; % E0 = 1, unit amplitude at focus
end
